...
const Sidebar = ({ isOpen, isCollapsed, setIsOpen }) => {
    ...
    <>
      ...
      `}>
          ...
          <div className="space-y-1">
            {userMenuItems.map((item) => (
              <NavLink
                ...
                className={`
                  flex items-center ${isCollapsed ? 'justify-center px-3' : 'gap-3 px-4'} py-3 rounded-xl transition-all duration-200
                  ${isActive(item.path)
              ...
              >
                ...
                {!isCollapsed && isActive(item.path) && <ChevronRight className="w-4 h-4 ml-auto" />}
              </NavLink>
            ))}
          </div>
        ...
        <div className="p-3 border-t border-slate-200/50 dark:border-slate-700/50">
          <div className={`flex items-center px-3 py-3 rounded-xl bg-slate-100/50 dark:bg-slate-800/50 mb-2 ${isCollapsed ? 'justify-center' : 'gap-3'}`}>
          ...
          <button
            ...
            className={`w-full flex items-center ${isCollapsed ? 'justify-center px-3' : 'gap-3 px-4'} py-3 rounded-xl text-danger-600 dark:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition-colors`}
          >
